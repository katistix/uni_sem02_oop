...
void test_domain_Produs() {
    const Produs p(1, "Laptop", "Electronics", 1500.0, "Dell");
...
void test_service_getAll_empty() {
    RepoProduse repo;
    const ServiceProduse service(repo);
...
void test_sort_byNume() {
    ...
    const auto rezultat = service.sortByFunction(cmpByNume);
...
void test_sort_byNumeDesc() {
    ...
    const auto rezultat = service.sortByFunction(cmpByNumeDesc);
...
void test_sort_byPret() {
    ...
    const auto rezultat = service.sortByFunction(cmpByPret);
...
void test_sort_byPretDesc() {
    ...
    const auto rezultat = service.sortByFunction(cmpByPretDesc);
...
void test_sort_byNumeSiTip() {
    ...
    const auto rezultat = service.sortByFunction(cmpByNumeSiTip);
...
void test_filter_byPretMax() {
    ...
    const auto rezultat = service.filterByFunction(filterByPretMax);
...
void test_filter_byProducator() {
    ...
    const auto rezultat = service.filterByFunction(filterByProducator);
    assert(rezultat.size() == 2);
...
void test_filter_byTip() {
    ...
    const auto rezultat = service.filterByFunction(filterByTip);
    assert(rezultat.size() == 2);
